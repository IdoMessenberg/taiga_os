//*/-bootloader/lib/efi_elf_loader/src/main.rs
#![no_std]
...
pub fn load_executable(system_table: &efi::system::Table, file: &std_alloc::vec::Vec<u8>) -> Result<usize, efi::Status> {
    ...
    if header.e_ident[EI_MAG_0 as usize] != ELF_MAG_0 ||
    header.e_ident[EI_MAG_1 as usize] != ELF_MAG_1  ||
    header.e_ident[EI_MAG_2 as usize] != ELF_MAG_2 ||
    header.e_ident[EI_MAG_3 as usize] != ELF_MAG_3 {
